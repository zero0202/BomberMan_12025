...
AEnemigoGolen::AEnemigoGolen()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> ObjetoBloqueMaterial(TEXT("/Script/Engine.Material'/Game/StarterContent/Materials/NewMaterial.NewMaterial'"));
...
void AEnemigoGolen::Tick(float DeltaTime)
{
...
void AEnemigoGolen::CambiarDireccion()
{
