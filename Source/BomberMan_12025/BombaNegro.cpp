...
ABombaNegro::ABombaNegro()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> ObjetoBloqueAceroMaterial(TEXT("/Script/Engine.Material'/Game/StarterContent/Materials/M_Rock_Basalt.M_Rock_Basalt'"));
...
void ABombaNegro::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void ABombaNegro::Explotar()
{
