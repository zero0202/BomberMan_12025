...
AEnemigoSaltarin::AEnemigoSaltarin()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> ObjetoBloqueMaterial(TEXT("/Script/Engine.Material'/Game/StarterContent/Materials/Golenn.Golenn'"));
...
void AEnemigoSaltarin::BeginPlay()
{
	Super::BeginPlay();
...
void AEnemigoSaltarin::Tick(float DeltaTime)
{
...
void AEnemigoSaltarin::IniciarSalto()
{
...
FVector AEnemigoSaltarin::CalcularNuevoDestino()
{
